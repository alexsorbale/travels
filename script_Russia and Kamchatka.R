#Îáùàÿ çà èþëü-àâãóñò

flights <- read.csv("C:/Users/alexs/Desktop/Ïóòåøåñòâèÿ Ð/flights.csv", sep=';', stringsAsFactors = FALSE)
...
Kamchatka <- subset(Russia, NL_NAME_1 == "Êàì÷àòñêàÿ êðàé") 
...
Kamchatka@data$Days <- c('íå áûë', 'íå áûë', '2-9 èþëÿ', 'íå áûë', 'íå áûë', 'íå áûë', 'íå áûë', 'íå áûë', 'íå áûë', 'íå áûë', '10 èþëÿ') 
...
Kamchatka_to_map$Days <- factor(Kamchatka_to_map$Days, levels = c("2-9 èþëÿ", "10 èþëÿ", "íå áûë"))
...
kamchatka_places <- read.csv("C:/Users/alexs/Desktop/Ïóòåøåñòâèÿ Ð/Kamchatka.csv", sep=';', stringsAsFactors = FALSE)
...
scale_shape_manual(name = "Îáîçíà÷åíèÿ", values = c(16, 17, 8), labels = c("Íàñåë¸ííûå ïóíêòû", "Âóëêàíû", "Çàïîâåäíèêè è ïàðêè"))+
scale_color_manual(name = "Îáîçíà÷åíèÿ", values = c('red', '#970027', 'darkgreen'), labels = c("Íàñåë¸ííûå ïóíêòû", "Âóëêàíû", "Çàïîâåäíèêè è ïàðêè"))
Kamchatka_points
